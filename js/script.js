...
//merry characters - taken from the unicode charset
var merry = ":"
...
function draw()
{
	...
	ctx.fillStyle = "#FBFF82"; //color text
	ctx.font = font_size + "px arial";
	//looping over drops
	for(var i = 0; i < drops.length; i++)
	{
		//a random merry character to print
		var text = merry[Math.floor(Math.random()*merry.length)];
